...
function useSidebarWidth() {
  const [width, _setWidth] = React.useState(() => {
    ...
    if (savedWidth) {
      ...
      if (parsed >= SIDEBAR_WIDTH_MIN && parsed <= SIDEBAR_WIDTH_MAX) {
        return parsed;
      }
    }
...
const SidebarProvider = ({
  ...
  // Sync sidebar state to cookie for persistence
  React.useEffect(() => {
...
export {
  ...
  SidebarSeparator,
  SidebarTrigger,
  // eslint-disable-next-line react-refresh/only-export-components -- Hook exported alongside sidebar components (standard UI library pattern)
  useSidebar,
};
