 ...
 */
export const getThreadTitle = (interrupt: HumanInterrupt): string => {
 ...
 */
export const getActionsDisabled = (
  loading: boolean,
  streaming: boolean,
): boolean => {
 ...
 */
export const getIgnoreAllowed = (interrupt: HumanInterrupt): boolean => {
